...
const BASE_URL = `https://api.themoviedb.org/3/discover/movie?api_key=${API_KEY}&sort_by=release_date.desc&vote_count.gte=${MIN_VOTE_COUNT}&primary_release_date.lte=${new Date().toISOString().split('T')[0]}`;
